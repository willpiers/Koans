...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    ## My Explanation ##
    # inject is the best method ever. You call it on an Enumerable
    # (think of an array), and it gives you the ability to go through
    # the elements one at a time, each time modifying a value that you provide.
    # It is perfect for a factorial function.
    # i.e. (1..n).inject(1) { |product, entry| product*entry }
    # this will go through each integer from 1 to n and multiply 1 (which I provided)
    # by that integer.
  end
